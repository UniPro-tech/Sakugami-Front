...
// TODO: アトリビュートを整理する
export interface Teams extends DataModel {
  id: number;
  name: string;
  customId: string;
...
export const teamsDataSource: DataSource<Teams> = {
  fields: [
    ...
    },
    {
      ...
      renderCell: (params) => {
        const employee = params.row.owner as Employee;
...
export const teamsCache = new DataSourceCache();
